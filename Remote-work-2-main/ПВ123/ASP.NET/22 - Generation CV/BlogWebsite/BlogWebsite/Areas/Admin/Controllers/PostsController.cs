...
namespace BlogWebsite.Areas.Admin.Controllers
{
    ...
    public class PostsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Header,Description,Content,Date,CategoryId")] Post post)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Header,Description,Content,Date,CategoryId")] Post post)
        {
            if (id != post.Id)
            {
                return NotFound();
